...
try {
    ...
    $streams = Invoke-RestMethod -Uri "https://yoyoapi.5202021.xyz/api/streams" -Method GET -Headers $headers -TimeoutSec 10
...
try {
    ...
    $vpsResult = Invoke-RestMethod -Uri "https://yoyo-vps.5202021.xyz/api/simple-stream/start-watching" -Method POST -Headers $vpsHeaders -Body $vpsBody -TimeoutSec 15
...
try {
    ...
    $workersResult = Invoke-RestMethod -Uri "https://yoyoapi.5202021.xyz/api/simple-stream/start-watching" -Method POST -Headers $workersHeaders -Body $workersBody -TimeoutSec 15
