...
```bash
# 1. 测试录制启动
curl -X POST https://yoyo-vps.5202021.xyz/api/simple-stream/start-recording \
...
# 2. 检查录制状态
curl https://yoyo-vps.5202021.xyz/api/simple-stream/recording-status/stream_xxx \
  -H "X-API-Key: YOUR_KEY"
...
# 4. 测试录制停止
curl -X POST https://yoyo-vps.5202021.xyz/api/simple-stream/stop-recording \
  -H "X-API-Key: YOUR_KEY" \
    ...
    "files": [
      {
        ...
        "fileBrowserUrl": "https://files.yoyo.5202021.xyz/files/stream_xxx/2025-10-22_07-50_17-20.mp4"
      },
      {
        "id": "rec_1234567891",
        "channelId": "stream_xxx",
    ...
    "files": [
      {
        ...
        "file_size": 734003200,
        "status": "completed",
        "fileBrowserUrl": "https://files.yoyo.5202021.xyz/files/stream_xxx/2025-10-22_07-50_segment.mp4"
      }
    ]
  }
}
...
Response:
{
  "url": "https://files.yoyo-vps.5202021.xyz",
  "username": "viewer",
...
**FileBrowser配置**:
- 访问地址: `https://files.yoyo-vps.5202021.xyz`
...
FILEBROWSER_URL = "https://cloud.5202021.xyz"  # 实际部署地址
```
...
const openFileBrowser = () => {
  ...
  window.open('https://cloud.5202021.xyz/', '_blank')
...
const openRecordingsFolder = () => {
  window.open('https://cloud.5202021.xyz/files/yoyo-k/', '_blank')
}

// 或者直接跳转到特定频道的录制目录
const openChannelRecordings = (channelId) => {
  window.open(`https://cloud.5202021.xyz/files/yoyo-k/${channelId}/`, '_blank')
}
```
...
3. 用户通过 https://cloud.5202021.xyz/ 访问FileBrowser
