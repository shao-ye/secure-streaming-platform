...
# 2. 检查代理API端点
curl -H "X-API-Key: YOUR_API_KEY" https://yoyo-vps.your-domain.com/api/proxy/status
```
...
curl -H "X-API-Key: 85da076ae24b028b3d1ea1884e6b13c5afe34..." \
     https://yoyo-vps.your-domain.com/api/proxy/health
...
curl -v -H "X-API-Key: YOUR_KEY" \
     https://yoyo-vps.your-domain.com/api/proxy/status
