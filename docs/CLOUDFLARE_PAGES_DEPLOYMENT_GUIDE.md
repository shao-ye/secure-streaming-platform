...
- ✅ 所有配置文件已准备完毕
- ✅ Cloudflare Workers API已部署 (yoyoapi.your-domain.com)
- ✅ 环境变量配置正确
...
1. 部署完成后，进入Pages项目设置
2. 选择 **"Custom domains"**
3. 添加自定义域名: `yoyo.your-domain.com`
4. 等待DNS验证完成
...
**_redirects文件** (已存在):
```
/api/* https://yoyoapi.your-domain.com/api/:splat 200
/hls/* https://yoyoapi.your-domain.com/hls/:splat 200
/* /index.html 200
```
...
- **主页**: https://yoyo.your-domain.com
- **登录页**: https://yoyo.your-domain.com/login
- **管理页**: https://yoyo.your-domain.com/admin

### 3. API连接验证
在浏览器开发者工具中检查：
- API请求是否正确代理到 `yoyoapi.your-domain.com`
- 登录功能是否正常
- 流列表是否正常加载
...
- **前端地址**: https://yoyo.your-domain.com
- **API地址**: https://yoyoapi.your-domain.com
- **VPS地址**: https://yoyo-vps.your-domain.com
