...
3. **✅ 播放API**: 完全正常
   ```json
   {
     ...
     "data": {
       ...
       "hlsUrl": "https://yoyo-vps.your-domain.com/hls/frontend_test_094257/playlist.m3u8",
...
Invoke-RestMethod -Uri "https://yoyo-vps.your-domain.com/api/simple-stream/start-watching" -Method POST -Body $testData -ContentType "application/json"
```
