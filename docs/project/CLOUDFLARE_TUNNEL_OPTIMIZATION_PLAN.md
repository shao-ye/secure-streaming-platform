...
页面规则设置:
```
URL: *.yoyo-vps.your-domain.com/hls/*
...
export const TUNNEL_CONFIG = {
  // 隧道端点 (主要)
  TUNNEL_ENDPOINTS: {
    API: 'https://tunnel-api.yoyo-vps.your-domain.com',
    HLS: 'https://tunnel-hls.yoyo-vps.your-domain.com',
    HEALTH: 'https://tunnel-health.yoyo-vps.your-domain.com'
  },
  // 直连端点 (备用)
  DIRECT_ENDPOINTS: {
    API: 'https://yoyo-vps.your-domain.com',
    HLS: 'https://yoyo-vps.your-domain.com',
    HEALTH: 'https://yoyo-vps.your-domain.com'
  },
  // 从环境变量读取配置 (带默认值)
...
class APIService {
  constructor() {
    ...
    this.baseURL = 'https://yoyoapi.your-domain.com'; // 通过隧道优化
  }
