...
const channelPaths = {
  'stream_ensxma2g': {
    rtmpSource: '<RTMP_URL>', // 源不变
    accessPaths: [
      { type: 'proxy', url: 'https://yoyoapi.your-domain.com/hls/...' },
      { type: 'direct', url: 'https://yoyo-vps.your-domain.com/hls/...' },
      { type: 'tunnel', url: 'https://tunnel-hls.yoyo-vps.your-domain.com/hls/...' }
    ]
  }
};
```
...
const routingOptimizationScenario = {
  ...
  routingTypes: {
    tunnelOptimized: 'tunnel-hls.yoyo-vps.your-domain.com', // 隧道优化路径
    workersProxy: 'yoyoapi.your-domain.com/hls/',           // Workers代理路径  
    directConnection: 'yoyo-vps.your-domain.com'            // 直连路径
  },
...
class MigrationErrorHandler {
  ...
  async fallbackToDirectConnection(user) {
    const directUrl = `https://yoyo-vps.your-domain.com/hls/${user.channelId}/playlist.m3u8`;
