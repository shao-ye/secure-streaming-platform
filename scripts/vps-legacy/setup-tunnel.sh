...
echo "   tunnel-api.yoyo-vps.your-domain.com    → CNAME → yoyo-streaming.cfargotunnel.com"
echo "   tunnel-hls.yoyo-vps.your-domain.com    → CNAME → yoyo-streaming.cfargotunnel.com"
echo "   tunnel-health.yoyo-vps.your-domain.com → CNAME → yoyo-streaming.cfargotunnel.com"
echo ""
echo "4. 测试隧道连接:"
...
echo "6. 验证服务:"
echo "   pm2 status"
echo "   curl https://tunnel-health.yoyo-vps.your-domain.com/health"
echo ""
