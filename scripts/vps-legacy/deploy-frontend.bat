...
set "VPS_HOST=yoyo-vps.your-domain.com"
set "VPS_USER=root"
...
(
echo # 生产环境配置 - VPS部署
echo VITE_API_BASE_URL=https://yoyoapi.your-domain.com
echo VITE_APP_TITLE=YOYO流媒体平台
echo VITE_APP_VERSION=1.0.0
echo VITE_HLS_PROXY_URL=https://yoyoapi.your-domain.com/hls
echo VITE_ENVIRONMENT=production
echo VITE_WORKER_URL=https://yoyoapi.your-domain.com
echo VITE_DEBUG=false
echo VITE_LOG_LEVEL=error
echo VITE_VPS_DOMAIN=yoyo.your-domain.com
) > .env.production
...
echo    server {
echo        listen 80;
echo        server_name yoyo.your-domain.com;
...
echo        # API代理到Workers
echo        location /api/ {
echo            proxy_pass https://yoyoapi.your-domain.com/api/;
...
echo        # HLS代理
echo        location /hls/ {
echo            proxy_pass https://yoyoapi.your-domain.com/hls/;
echo            add_header Access-Control-Allow-Origin *;
echo        }
echo.
echo        # SPA路由支持
...
echo.
echo 📊 部署后访问地址:
echo   前端: http://yoyo.your-domain.com
echo   管理后台: http://yoyo.your-domain.com/admin
echo   API: https://yoyoapi.your-domain.com
echo.
