...
|------|-----------|--------|------|---------|
| HTTP | tunnel-api | yoyo-vps.your-domain.com | | http://localhost:3000 |
| HTTP | tunnel-hls | yoyo-vps.your-domain.com | | http://localhost:8080 |
| HTTP | tunnel-health | yoyo-vps.your-domain.com | | http://localhost:3000/health |
