...
echo "测试 tunnel-health.yoyo-vps.your-domain.com/health:"
if curl -s -I https://tunnel-health.yoyo-vps.your-domain.com/health 2>/dev/null | head -1; then
...
echo ""
echo "测试 tunnel-api.yoyo-vps.your-domain.com/health:"
if curl -s -I https://tunnel-api.yoyo-vps.your-domain.com/health 2>/dev/null | head -1; then
...
echo ""
echo "📊 隧道端点:"
echo "- API服务: https://tunnel-api.yoyo-vps.your-domain.com"
echo "- HLS文件: https://tunnel-hls.yoyo-vps.your-domain.com"
echo "- 健康检查: https://tunnel-health.yoyo-vps.your-domain.com"
echo ""
echo "📋 管理命令:"
...
echo ""
echo "🔗 下一步:"
echo "1. 访问 https://yoyo.your-domain.com/admin"
echo "2. 进入'隧道优化'选项卡"
echo "3. 启用隧道优化功能"
echo ""
echo "📊 当前进程:"
