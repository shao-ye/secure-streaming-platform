...
|-----------|--------|------|---------|
| tunnel-api | yoyo-vps.your-domain.com | | http://localhost:3000 |
| tunnel-hls | yoyo-vps.your-domain.com | | http://localhost:8080 |
| tunnel-health | yoyo-vps.your-domain.com | | http://localhost:3000/health |
...
# 测试连接
curl https://tunnel-health.yoyo-vps.your-domain.com
```
