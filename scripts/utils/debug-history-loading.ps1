...
try {
    $proxyConfig = Invoke-RestMethod -Uri "https://yoyoapi.your-domain.com/api/admin/proxy/config" -Method GET -Headers $headers -TimeoutSec 10
    ...
    try {
        $r2Status = Invoke-RestMethod -Uri "https://yoyoapi.your-domain.com/api/admin/debug/r2-storage" -Method GET -Headers $headers -TimeoutSec 10
    ...
    try {
        $historyBefore = Invoke-RestMethod -Uri "https://yoyoapi.your-domain.com/api/admin/proxy/test-history/$($testProxy.id)" -Method GET -Headers $headers -TimeoutSec 10
    ...
    $testResult = Invoke-RestMethod -Uri "https://yoyoapi.your-domain.com/api/admin/proxy/test" -Method POST -Headers $headers -Body $testData -TimeoutSec 25
    ...
    try {
        $r2StatusAfter = Invoke-RestMethod -Uri "https://yoyoapi.your-domain.com/api/admin/debug/r2-storage" -Method GET -Headers $headers -TimeoutSec 10
    ...
    try {
        $historyAfter = Invoke-RestMethod -Uri "https://yoyoapi.your-domain.com/api/admin/proxy/test-history/$($testProxy.id)" -Method GET -Headers $headers -TimeoutSec 10
    ...
    foreach ($proxy in $proxies) {
        try {
            $history = Invoke-RestMethod -Uri "https://yoyoapi.your-domain.com/api/admin/proxy/test-history/$($proxy.id)" -Method GET -Headers $headers -TimeoutSec 5
