...
try {
    ...
    $response = Invoke-RestMethod -Uri "https://yoyo-vps.your-domain.com/api/proxy/connect" -Method POST -Body $requestBody -ContentType "application/json" -TimeoutSec 30
    ...
    $status = Invoke-RestMethod -Uri "https://yoyo-vps.your-domain.com/api/proxy/status" -Method GET -TimeoutSec 10
