...
try {
    $initialStatus = Invoke-RestMethod -Uri "https://yoyo-vps.your-domain.com/api/proxy/status" -Method GET -TimeoutSec 10
...
try {
    $disconnectResult = Invoke-RestMethod -Uri "https://yoyo-vps.your-domain.com/api/proxy/disconnect" -Method POST -ContentType "application/json" -TimeoutSec 10
...
try {
    ...
    $connectResult = Invoke-RestMethod -Uri "https://yoyo-vps.your-domain.com/api/proxy/connect" -Method POST -Body $testProxyConfig -ContentType "application/json" -TimeoutSec 30
...
for ($i = 1; $i -le 5; $i++) {
    ...
    try {
        $postStatus = Invoke-RestMethod -Uri "https://yoyo-vps.your-domain.com/api/proxy/status" -Method GET -TimeoutSec 10
...
try {
    $healthCheck = Invoke-RestMethod -Uri "https://yoyo-vps.your-domain.com/health" -Method GET -TimeoutSec 10
